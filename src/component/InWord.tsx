...
const InWord = (value: string, lang: string = 'pt-br') =>{

    if(value){
        let language: any = 'pt-br'
        ...
        let and = Currency.find(c => c.type === language)?.separator

        let coin = Currency.find(c => c.type === language)?.fraction
        let correncyType: any = Currency.find(c => c.type === language)
